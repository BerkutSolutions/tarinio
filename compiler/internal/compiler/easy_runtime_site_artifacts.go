...
func renderEasySiteArtifacts(site SiteInput, profile EasyProfileInput) ([]ArtifactOutput, bool, int, int, error) {
	...
	antibotExclusionRules := appendAntibotExclusionRules(profile.AntibotExclusionRules, easyAdminAntibotExclusionRulesForSite(site))
	authExclusionRules := appendAuthExclusionRules(profile.AuthExclusionRules, easyAdminAuthExclusionRulesForSite(site))
	data := easySiteData{
		SiteID:                       site.ID,
		...
		AdminBypassPathPattern:       easyAdminBypassPathPatternForSite(site),
		ModSecurityBypassPathPattern: easyModSecurityBypassPathPatternForSite(site),
		...
		AllowLocalCountryIPs:         profile.AllowLocalCountryIPs,
		...
		ModSecurityEasyRules: buildEasyModSecurityRules(
			...
			profile.ModSecurityExclusionRules,
