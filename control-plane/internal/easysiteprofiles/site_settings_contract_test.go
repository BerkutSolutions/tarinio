...
func TestSiteSettings_FieldContract(t *testing.T) {
	...
	want := []string{
		...
		"front_service.mtls_client_ca_ref",
		"front_service.mtls_enabled",
		"front_service.mtls_optional",
		"front_service.mtls_pass_headers",
		"front_service.mtls_verify_depth",
		...
		"http_behavior.http2",
		"http_behavior.http3",
		"http_behavior.http_strict_parsing",
		...
		"security_antibot.antibot_challenge_template",
		...
		"security_behavior_and_limits.blacklist_ja3",
		"security_behavior_and_limits.blacklist_ja3_urls",
		...
		"security_country_policy.geo_time_windows.hours_end",
		"security_country_policy.geo_time_windows.hours_start",
		...
		"security_modsecurity.exclusion_rules.comment",
		"security_modsecurity.exclusion_rules.methods",
		"security_modsecurity.exclusion_rules.mode",
		"security_modsecurity.exclusion_rules.path",
		"security_modsecurity.exclusion_rules.path_pattern",
		"security_modsecurity.exclusion_rules.rule_ids",
		"security_modsecurity.exclusion_rules.targets",
		...
		"security_websocket.use_ws_inspection",
		"security_websocket.ws_block_patterns",
		"security_websocket.ws_max_message_bytes",
		"security_websocket.ws_rate_msg_per_sec",
		"site_id",
		"updated_at",
		"virtual_patches.action",
		"virtual_patches.id",
		"virtual_patches.pattern",
		"virtual_patches.target",
		...
		"upstream_routing.health_check_enabled",
		"upstream_routing.health_check_path",
		"upstream_routing.health_check_interval_seconds",
		"upstream_routing.health_check_fail_threshold",
		"upstream_routing.upstream_mtls_ca_ref",
		"upstream_routing.upstream_mtls_cert_ref",
		"upstream_routing.upstream_mtls_enabled",
		"upstream_routing.upstream_mtls_key_ref",
	}
	sort.Strings(got)
	sort.Strings(want)
