...
func NewAdminScriptService(revisionStoreDir string, scriptsRoot string) *AdminScriptService {
	definitions := []AdminScriptDefinition{
		...
		},
		{
			...
			Fields: []AdminScriptField{
				{Name: "WAF_USER", Label: "WAF Username", LabelKey: "administration.scripts.field.wafUsername", Type: "text", Required: true},
				{Name: "WAF_PASS", Label: "WAF Password", LabelKey: "administration.scripts.field.wafPassword", Type: "password", Required: true},
