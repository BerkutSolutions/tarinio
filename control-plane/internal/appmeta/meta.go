...
var AppVersion = "1.1.20"

const (
	ProductName = "Berkut Solutions - TARINIO"

	RepositoryURL = "https://github.com/BerkutSolutions/tarinio"

	GitHubAPIReleases = "https://api.github.com/repos/BerkutSolutions/tarinio/releases/latest"
)
