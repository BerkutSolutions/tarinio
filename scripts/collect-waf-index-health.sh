...
run_sh "opensearch_indices.txt" "docker exec '$OPENSEARCH_CONTAINER' bash -lc \"exec 3<>/dev/tcp/127.0.0.1/9200; printf 'GET /_cat/indices?v HTTP/1.0\r\nHost: 127.0.0.1\r\n\r\n' >&3; cat <&3\""
run_sh "opensearch_aliases.txt" "docker exec '$OPENSEARCH_CONTAINER' bash -lc \"exec 3<>/dev/tcp/127.0.0.1/9200; printf 'GET /_cat/aliases?v HTTP/1.0\r\nHost: 127.0.0.1\r\n\r\n' >&3; cat <&3\""
