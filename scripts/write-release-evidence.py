...
SUITE_DESCRIPTIONS = {
    "api-workflows": "Контракты API, Dashboard, запросы, события, настройки сайтов, ревизии и аудит на одноразовом WAF-стенде.",
    "api-registry": "Точное покрытие зарегистрированных API/runtime workflow: schema, enterprise, CRS и контракты.",
    "runtime-mtls": "Реальное входящее и исходящее mTLS, reload готовности и virtual patches в runtime.",
    "autostart": "Автозапуск и L7 Anti-DDoS с фактическим runtime HTTP 429.",
    "security-probes": "Поведенческие security probes, AntiBot, DAST API и runtime-защита.",
    "ui-server-contract": "Контракт UI-сервера: assets, routing, session ping и Services после login.",
    "browser-core": "Desktop/mobile Browser E2E: login, Dashboard, Requests, Events, Activity и базовая навигация.",
    "browser-services": "Desktop/mobile Services: создание, редактирование, Basic Auth, AntiBot и операции с сервисами.",
    "browser-services-controls": "Desktop/mobile Services: сертификаты, динамические поля и runtime-настройки.",
    "browser-services-editor": "Desktop/mobile Services editor: навигация, error pages и справка.",
    "browser-services-editor-import": "Desktop/mobile Services: import/export и mobile layout.",
    "browser-services-security": "Desktop/mobile Services: protection, RBAC и runtime resilience.",
    "browser-services-security-patches": "Desktop/mobile Services: validation и virtual patches.",
    "browser-platform": "Desktop/mobile platform: bans, revisions, Anti-DDoS, CRS, TLS и administration.",
    "browser-settings-cross": "Desktop/mobile Settings и cross-module security/compile/i18n проверки.",
    "browser-requests-backend-failure": "Реальный отказ backend Requests с сохранением работоспособности browser shell.",
    "api-workflows": "Контракты API, Dashboard, запросы, события, настройки сайтов, ревизии и аудит на одноразовом WAF-стенде.",
    "api-registry": "Точное покрытие зарегистрированных API/runtime workflow: schema, enterprise, CRS и контракты.",
    "runtime-mtls": "Реальное входящее и исходящее mTLS, reload готовности и virtual patches в runtime.",
    "autostart": "Автозапуск и L7 Anti-DDoS с фактическим runtime HTTP 429.",
