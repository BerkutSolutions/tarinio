...
This page records the reproducible enterprise validation pack for tarinio-sentinel in TARINIO 1.4.2.
...
Dokument fiksiruet vosproizvodimyy enterprise validation pack dlya `tarinio-sentinel` v TARINIO `1.4.2`.
