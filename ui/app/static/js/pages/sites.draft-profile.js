...
export function applyEasyProfileToDraft(draft, profile, deps) {
  ...
  return {
    ...
    blacklist_ja3: deps.normalizeStringArray(security.blacklist_ja3),
    ...
    blacklist_ja3_urls: deps.normalizeStringArray(security.blacklist_ja3_urls),
    ...
    antibot_session_inactivity_minutes: deps.normalizeAuthSessionTTLMinutes(antibot.session_inactivity_minutes ?? draft.antibot_session_inactivity_minutes),
