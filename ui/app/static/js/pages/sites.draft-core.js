...
export function defaultSiteDraft() {
  return {
    ...
    antibot_challenge: "no", antibot_challenge_template: "v1", antibot_uri: "/challenge", antibot_session_inactivity_minutes: 10, antibot_scanner_auto_ban_enabled: false, antibot_recaptcha_score: 0.7, antibot_recaptcha_sitekey: "", antibot_recaptcha_secret: "",
    ...
    challenge_escalation_mode: "javascript", antibot_challenge_rules: [], use_auth_basic: false, auth_mode: "basic", auth_order: "auth_first", auth_basic_user: "changeme", auth_basic_password: "",
 auth_basic_template: "v1", auth_basic_users: [{ username: "changeme", password: "", enabled: true, last_login_at: "" }], auth_exclusion_rules: [], auth_service_tokens: [], auth_basic_session_inactivity_minutes: 60,
    blacklist_country: [], whitelist_country: [], allow_local_country_ips: false, geo_time_windows: [], api_positive_security_enabled: false, api_positive_openapi_schema_ref: "", api_positive_enforcement_mode: "monitor",
...
export function draftToEasyProfile(draft) {
  ...
  return {
    ...
    security_antibot: {
      antibot_challenge: draft.antibot_challenge, antibot_challenge_template: draft.antibot_challenge_template || "v1", antibot_uri: draft.antibot_uri, session_inactivity_minutes: normalizeAuthSessionTTLMinutes(draft.antibot_session_inactivity_minutes), scanner_auto_ban_enabled: Boolean(draft.antibot_scanner_auto_ban_enabled),
    ...
    security_auth_basic: {
      use_auth_basic: draft.use_auth_basic, auth_mode: normalizeAuthMode(draft.auth_mode), auth_order: normalizeAuthOrder(draft.auth_order),
      auth_basic_user: firstUser.username, auth_basic_password: firstUser.password, auth_basic_template: draft.auth_basic_template || "v1",
    ...
    security_country_policy: { blacklist_country: draft.blacklist_country, whitelist_country: draft.whitelist_country, allow_local_ips: Boolean(draft.allow_local_country_ips), show_geo_block_page: Boolean(draft.show_geo_block_page), geo_time_windows: normalizeGeoTimeWindows(draft.geo_time_windows) },
