...
- Прозрачный режим и режим наблюдения сохраняют пассивное поведение без включённых модулей безопасности: не подключают ModSecurity, blacklist, antibот, auth-gate, geo-блокировки, rate-limit и L4 guard даже если черновик содержал включённые защитные настройки.
