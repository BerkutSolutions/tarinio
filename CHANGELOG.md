...
- Исправлена автоматическая публикация: release job получает DAST evidence до создания GitHub Release; версия повышена после уже опубликованного тега `v1.5.6`.
