...
### Версия
- Версия приложения обновлена до `1.0.8` (`control-plane/internal/appmeta/meta.go`).
- Версия документации и корневых README синхронизирована на `1.0.8`.
...
### Версия
- Версия приложения обновлена до `1.0.5` (`control-plane/internal/appmeta/meta.go`).
- Версия документации и корневых README синхронизирована на `1.0.5`.
