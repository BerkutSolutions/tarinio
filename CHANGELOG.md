...
- Обновлён UI contract-check для auth help modals, чтобы helper bridge использовал реальные импортированные renderer-символы, а не отсутствующие локальные alias-имён.
