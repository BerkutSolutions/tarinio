...
- Исправлена автоматическая публикация: release job получает DAST evidence до создания GitHub Release; версия повышена после уже опубликованных тегов `v1.5.6` и `v1.5.7`.
