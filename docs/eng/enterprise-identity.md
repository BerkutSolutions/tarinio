...
This document describes the real enterprise identity model in TARINIO `2.0.6`.
...
TARINIO `2.0.6` does **not** expose a standalone direct `LDAP` password-login endpoint.
