...
This document describes the real enterprise identity model in TARINIO `2.0.8`.

## What Is Implemented

TARINIO `2.0.8` provides:
...
TARINIO `2.0.8` does **not** expose a standalone direct `LDAP` password-login endpoint.
