...
This document describes the real enterprise identity model in TARINIO `2.0.7`.
...
TARINIO `2.0.7` does **not** expose a standalone direct `LDAP` password-login endpoint.
