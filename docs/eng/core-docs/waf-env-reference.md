...
| `WAF_SITE_CUSTOM_LIMIT_RULES` | Route-specific rate-limit rules. | JSON array of `{ "path": "/...", "rate": "Nr/s" }` | `[]` | `[{"path":"/login","rate":"10r/s"},{"path":"/core-docs/api/2/envelope/","rate":"30r/s"}]` |
