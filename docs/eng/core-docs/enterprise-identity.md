...
This document describes the real enterprise identity model in TARINIO `3.0.0`.
...
TARINIO `3.0.0` does **not** expose a standalone direct `LDAP` password-login endpoint.
