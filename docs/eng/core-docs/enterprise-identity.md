...
This document describes the real enterprise identity model in TARINIO `1.3.5`.

## What Is Implemented

TARINIO `1.3.5` provides:
...
TARINIO `1.3.5` does **not** expose a standalone direct `LDAP` password-login endpoint.
