...
This document describes the real TARINIO administrative interface for version `3.0.0`: login, onboarding, healthcheck, the sidebar sections, and the practical workflows behind each screen.
...
This is the core change-management screen in `3.0.0`.
