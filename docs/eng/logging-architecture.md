...
This document describes the real request-log behavior in TARINIO `2.0.8`.
...
This keeps the `2.0.5 -> 2.0.8` transition safe:
...
Healthy `2.0.8` behavior looks like this:
