...
This document describes the real request-log behavior in TARINIO `2.0.6`.
...
This keeps the `2.0.5 -> 2.0.6` transition safe:
...
Healthy `2.0.6` behavior looks like this:
