...
This document describes the real request-log behavior in TARINIO `2.0.9`.
...
This keeps the `2.0.5 -> 2.0.9` transition safe:
...
Healthy `2.0.9` behavior looks like this:
