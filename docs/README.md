...
Version baseline: `2.0.11`

This directory is the release-synced documentation set for TARINIO `2.0.11`.
...
- UI and operator workflows: `docs/ru/ui.md`
- Architecture: `docs/ru/architecture.md`
...
- UI and operator workflows: `docs/eng/ui.md`
