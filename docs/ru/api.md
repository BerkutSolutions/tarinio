...
Этот документ описывает актуальный HTTP API control-plane по состоянию версии `2.0.1`. Каталог составлен по реально зарегистрированным маршрутам из `control-plane/internal/httpserver/server.go`.
...
Новый агрегированный каталог ревизий в `2.0.1`.
