...
Документ описывает evidence-grade механизмы в TARINIO `2.0.9`: цепочку аудита, подписи ревизий, signed support bundle и release artifacts.

## Что реализовано

В TARINIO `2.0.9` реализованы:
