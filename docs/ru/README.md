...
Это основной русскоязычный индекс документации TARINIO. Он собран как операторская wiki для реальной версии `2.0.1` и покрывает не только архитектуру и deploy, но и повседневную работу в интерфейсе, жизненный цикл ревизий, безопасность, инциденты, резервное копирование и эксплуатационные сценарии.
