...
Это основной русскоязычный раздел документации TARINIO. Он собран как практическая wiki для операторов, администраторов и команд внедрения и отражает фактическое состояние версии `3.0.0`.
...
6. [Высокая доступность](high-availability-docs/high-availability.md)
7. [Наблюдаемость](core-docs/observability.md)
8. [Эксплуатация](core-docs/runbook.md)
9. [Обновление и откат](core-docs/upgrade.md)
10. [Резервное копирование и восстановление](core-docs/backups.md)
11. [CLI-команды](core-docs/cli-commands.md)
12. [Справочник env-параметров WAF](core-docs/waf-env-reference.md)
13. [Архитектура логгирования](architecture-docs/logging-architecture.md)
14. [Управление секретами](core-docs/secret-management.md)
15. [Контракт миграции и совместимости](core-docs/migration-compatibility.md)
...
## Что важно в релизах `2.0.7`-`3.0.0`
...
- `3.0.0`: поток проверки доведён до штатного браузерного перенаправления, а служебная активность admin UI исключена из пользовательской статистики запросов, атак и блокировок.
- Документация синхронизирована с фактическим состоянием продукта и release-срезом `2.0.7`-`3.0.0`.
