...
Это основной русскоязычный раздел документации TARINIO. Он собран как практическая wiki для операторов, администраторов и команд внедрения и отражает фактическое состояние версии `3.0.7`.
...
## Что важно в релизах `2.0.7`-`3.0.7`
...
- `3.0.6`: синхронизированы версии продукта/UI/документации, закреплена эволюция `ddos-model` в `tarinio-sentinel` и обновлены операционные руководства по адаптивной защите.
- `3.0.7`: добавлены базовый контур соответствия для внешнего периметра, предварительная проверка перед внешним сканированием, правила трактовки устаревших проверок и безопасный откат при регрессиях сканирования.
- Документация синхронизирована с фактическим состоянием продукта и release-срезом `2.0.7`-`3.0.7`.
