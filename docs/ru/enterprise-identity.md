...
Документ описывает фактически реализованную enterprise-модель идентификации в TARINIO `2.0.6`.

## Что реально реализовано

В TARINIO `2.0.6` доступны:
...
В TARINIO `2.0.6` **нет** отдельного прямого сценария входа по `LDAP`-паролю в control-plane.
