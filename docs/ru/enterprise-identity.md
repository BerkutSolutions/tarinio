...
Документ описывает фактически реализованную enterprise-модель идентификации в TARINIO `2.0.7`.

## Что реально реализовано

В TARINIO `2.0.7` доступны:
...
В TARINIO `2.0.7` **нет** отдельного прямого сценария входа по `LDAP`-паролю в control-plane.
