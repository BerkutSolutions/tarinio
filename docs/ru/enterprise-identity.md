...
Документ описывает фактически реализованную enterprise-модель идентификации в TARINIO `2.0.9`.

## Что реально реализовано

В TARINIO `2.0.9` доступны:
...
В TARINIO `2.0.9` **нет** отдельного прямого сценария входа по `LDAP`-паролю в control-plane.
