...
| `WAF_SITE_CUSTOM_LIMIT_RULES` | Точечные rate-limit правила по отдельным путям. | JSON-массив объектов `{ "path": "/...", "rate": "Nr/s" }` | `[]` | `[{"path":"/login","rate":"10r/s"},{"path":"/core-docs/api/2/envelope/","rate":"30r/s"}]` |
...
WAF_SITE_CUSTOM_LIMIT_RULES=[{"path":"/login","rate":"10r/s"},{"path":"/core-docs/api/","rate":"40r/s"}]
