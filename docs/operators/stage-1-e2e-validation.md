...
- This document records the single-node validation baseline only. For the newer HA control-plane topology and operator lab, see `docs/eng/high-availability-docs/high-availability.md`.
